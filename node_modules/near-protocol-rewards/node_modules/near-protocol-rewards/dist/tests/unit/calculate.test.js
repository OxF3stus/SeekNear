...
describe('calculate command', () => {
    ...
    it('should display complete rewards calculation results', async () => {
        ...
        jest.spyOn(sdk_1.GitHubRewardsSDK.prototype, 'getMetrics').mockResolvedValue(mockMetrics);
        jest.spyOn(sdk_1.GitHubRewardsSDK.prototype, 'startTracking').mockResolvedValue(undefined);
        jest.spyOn(sdk_1.GitHubRewardsSDK.prototype, 'stopTracking').mockResolvedValue(undefined);
